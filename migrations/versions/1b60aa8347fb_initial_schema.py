...
Revision ID: 1b60aa8347fb
Revises: 
Create Date: 2026-06-21 19:24:10.464694
...
def upgrade() -> None:
    ...
    # op.create_index('idx_location_logs_coordinates', 'location_logs', ['coordinates'], unique=False, postgresql_using='gist')
    op.create_index(op.f('ix_location_logs_id'), 'location_logs', ['id'], unique=False)
    op.create_index(op.f('ix_location_logs_vehicle_id'), 'location_logs', ['vehicle_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_location_logs_vehicle_id'), table_name='location_logs')
    op.drop_index(op.f('ix_location_logs_id'), table_name='location_logs')
    op.drop_index('idx_location_logs_coordinates', table_name='location_logs', postgresql_using='gist')
